...
use constant URIPUMPOMAT => "http://maac-lab.ddns.net:3443/pump_status.htm?ID=";

use Exporter qw(import);
our @EXPORT_OK = qw(DRIVER_INFORMIX DATABASE_INFORMIX DSN_INFORMIX USER_INFORMIX PASSWORD_INFORMIX DRIVER_MARIADB DATABASE_MARIADB DSN_MARIADB USER_MARIADB PASSWORD_MARIADB DEFAULT_FLEET_ID DEFAULT_DEPT_ID ORCU_ADDRESS SQLITE_DATABASE LOGGER TRUE FALSE ORCURETRIEVEFILE ESTACION WSURI WSPROXY WSUSER WSPASSWORD SITE_CODE WSXMLSCHEMA HO_ROLE PROVEEDOR INFORMIX_SERVER URIPUMPOMAT);
